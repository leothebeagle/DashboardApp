...
quotes = Quote.create([
    ...
    { author: "Khalil Gibran" , content: "Let there be spaces in your togetherness." },
    { author: "Khalil Gibran" , content: "Your pain is the breaking of the shell that encloses your understanding." },
